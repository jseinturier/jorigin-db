...
public class DatabaseProfile{
   ...
   * @param dbType the type of the database server (can be ODBC, MySQL, ..) specified by the class {@link org.jorigin.db.jdbc.JDBCConnection JDBCConnection}
   ...
   * @param dbServer the database server dns name (or IP)
   */
   ...
   * @param dbUserPassword the user password.
   */
   ...
   * @param dbServerPort the database server port.
   */
   ...
   * @param dbType the int representing the database server type.
   * @see org.jorigin.db.jdbc.JDBCConnection
   */
