...
public interface SQLToolkit {
   ...
   * @return <code>true</code> if the catalog is successfully deleted, <code>false</code> otherwise.
   * @throws JDBCConnectionException if errors occur.
   */
   ...
   * @return <code>true</code> if the schema is successfully deleted, <code>false</code> otherwise.
   * @throws JDBCConnectionException if errors occur.
   */
   ...
   * @param schema the schema containing tables to show.
